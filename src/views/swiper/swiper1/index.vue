<template>
  <div>
    <div id="wrapper">
      <section id="js-header" class="slideshow">
        <div
                  ...
                  <div class="slideshow__slide-background background-absolute">
                    ...
                    >
                      <div
                        ...
                        style="background-image: url('https://images.pexels.com/photos/190537/pexels-photo-190537.jpeg?auto=compress&cs=tinysrgb&h=1080&w=1920');"
                      />
                    </div>
                  </div>
                </div>
          ...
          <div class="slideshow__slide-caption">
            <div class="slideshow__slide-caption-text">
              ...
              >
                ...
                >
                  <span
                    class="slideshow__slide-caption-subtitle-label"
                  >See how</span>
                </a>
              </div>
            </div>
                ...
                >
                  <div class="slideshow__slide-background background-absolute">
                    ...
                    >
                      <div
                        class="slideshow__slide-image background-absolute"
                        style="background-image: url('https://images.pexels.com/photos/110649/pexels-photo-110649.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=1080&w=1920');"
                      />
                    </div>
                  </div>
                </div>
                ...
                >
                  <div class="slideshow__slide-background background-absolute">
                    ...
                    >
                      <div
                        class="slideshow__slide-image background-absolute"
                        style="background-image: url('https://images.pexels.com/photos/196666/pexels-photo-196666.jpeg?auto=compress&cs=tinysrgb&h=1080&w=1920');"
                      />
                    </div>
                  </div>
                </div>
...
class Slideshow {
  ...
  init() {
    ...
    if (this.showPagination) {
      const paginationNumber = this.maxSlide
      let pagination = '<div class="pagination"><div class="container">'

      for (let i = 0; i < this.maxSlide; i++) {
        const item = `<span class="pagination__item js-pagination-item ${
          i === 0 ? 'is-current' : ''
...
function load() {
  ...
  const slideShow = new Slideshow(options)
}
const $window = $(window)
const $body = $('body')
import $ from 'jquery'
