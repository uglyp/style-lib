<template>
  <div>
    <h1>图片的动态Hover效果与文字图标交互 Part I</h1>
    <div class="content">
      <h2>Lily</h2>
      <div class="grid">
      ...
      <div class="grid">
        <figure class="effect-zoe">
          ...
          <figcaption>
            ...
            <p class="icon-links">
              <a href="#"><span class="icon-heart" /></a>
              <a href="#"><span class="icon-eye" /></a>
              <a href="#"><span class="icon-paper-clip" /></a>
            </p>
            <p class="description">
      ...
      <div class="grid">
        <figure class="effect-marley">
          <img
            src="https://tympanus.net/Development/HoverEffectIdeas/img/11.jpg"
            alt="img11"
          >
          <figcaption>
      ...
      <div class="grid">
        <figure class="effect-roxy">
          <img
            src="https://tympanus.net/Development/HoverEffectIdeas/img/15.jpg"
            alt="img15"
          >
          <figcaption>
      ...
      <div class="grid">
        <figure class="effect-romeo">
          ...
          <figcaption>
            ...
            <p>
              Romeo never knows what he wants. He seemed to be very cross about
              something.
            </p>
            <a href="#">View more</a>
          </figcaption>
