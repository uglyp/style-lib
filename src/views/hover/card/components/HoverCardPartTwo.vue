  ...
  <div>
    <div class="content">
      ...
      <div class="grid">
        ...
        <figure class="effect-julia">
          <img
            src="https://tympanus.net/Development/HoverEffectIdeas/img/22.jpg"
            alt="img22"
          >
          <figcaption>
            <h2>Passionate <span>Julia</span></h2>
      ...
      <div class="grid">
        <figure class="effect-goliath">
          <img
            src="https://tympanus.net/Development/HoverEffectIdeas/img/23.jpg"
            alt="img23"
          >
          <figcaption>
      ...
      <div class="grid">
        <figure class="effect-hera">
          ...
          <figcaption>
            ...
            <p>
              <a href="#"><i class="fa fa-fw fa-file-pdf-o" /></a>
              <a href="#"><i class="fa fa-fw fa-file-image-o" /></a>
              <a href="#"><i class="fa fa-fw fa-file-archive-o" /></a>
              <a href="#"><i class="fa fa-fw fa-file-code-o" /></a>
            </p>
          </figcaption>
        </figure>
        <figure class="effect-hera">
      ...
      <div class="grid">
        <figure class="effect-winston">
          <img
            src="https://tympanus.net/Development/HoverEffectIdeas/img/30.jpg"
            alt="img30"
          >
          <figcaption>
            <h2>Jolly <span>Winston</span></h2>
            <p>
              <a href="#"><i class="fa fa-fw fa-star-o" /></a>
              <a href="#"><i class="fa fa-fw fa-comments-o" /></a>
              <a href="#"><i class="fa fa-fw fa-envelope-o" /></a>
            </p>
          </figcaption>
        </figure>
        <figure class="effect-winston">
      ...
      <div class="grid">
        ...
        <figure class="effect-selena">
          <img
            src="https://tympanus.net/Development/HoverEffectIdeas/img/31.jpg"
            alt="img31"
          >
          <figcaption>
            <h2>Happy <span>Selena</span></h2>
      ...
      <div class="grid">
        <figure class="effect-terry">
          ...
          <figcaption>
            ...
            <p>
              <a href="#"><i class="fa fa-fw fa-download" /></a>
              <a href="#"><i class="fa fa-fw fa-heart" /></a>
              <a href="#"><i class="fa fa-fw fa-share" /></a>
              <a href="#"><i class="fa fa-fw fa-tags" /></a>
            </p>
          </figcaption>
        </figure>
        <figure class="effect-terry">
      ...
      <div class="grid">
        <figure class="effect-phoebe">
          ...
          <figcaption>
            ...
            <p>
              <a href="#"><i class="fa fa-fw fa-user" /></a>
              <a href="#"><i class="fa fa-fw fa-heart" /></a>
              <a href="#"><i class="fa fa-fw fa-cog" /></a>
            </p>
          </figcaption>
        </figure>
        <figure class="effect-phoebe">
          <img
            src="https://tympanus.net/Development/HoverEffectIdeas/img/7.jpg"
            alt="img07"
          >
          <figcaption>
            <h2>Plain <span>Phoebe</span></h2>
      ...
      <div class="grid">
        <figure class="effect-kira">
          ...
          <figcaption>
            ...
            <p>
              <a href="#"><i class="fa fa-fw fa-home" /></a>
              <a href="#"><i class="fa fa-fw fa-download" /></a>
              <a href="#"><i class="fa fa-fw fa-heart" /></a>
              <a href="#"><i class="fa fa-fw fa-share" /></a>
            </p>
        ...
        <figure class="effect-kira">
          <img
            src="https://tympanus.net/Development/HoverEffectIdeas/img/5.jpg"
            alt="img05"
          >
          <figcaption>
            <h2>Dark <span>Kira</span></h2>
      ...
      <div class="grid">
        <figure class="effect-steve">
          <img
            src="https://tympanus.net/Development/HoverEffectIdeas/img/29.jpg"
            alt="img29"
          >
          <figcaption>
        ...
        <figure class="effect-steve">
          <img
            src="https://tympanus.net/Development/HoverEffectIdeas/img/33.jpg"
            alt="img33"
          >
          <figcaption>
            <h2>Lonely <span>Steve</span></h2>
      ...
      <div class="grid">
        ...
        <figure class="effect-moses">
          <img
            src="https://tympanus.net/Development/HoverEffectIdeas/img/20.jpg"
            alt="img20"
          >
          <figcaption>
            <h2>Cute <span>Moses</span></h2>
      ...
      <div class="grid">
        <figure class="effect-lexi">
          <img
            src="https://tympanus.net/Development/HoverEffectIdeas/img/12.jpg"
            alt="img12"
          >
          <figcaption>
      ...
      <div class="grid">
        <figure class="effect-duke">
          <img
            src="https://tympanus.net/Development/HoverEffectIdeas/img/27.jpg"
            alt="img27"
          >
          <figcaption>
