  ...
  <div class="container">
    ...
    <section>
      <div class="loader loader-21">
        <div class="css-times times1" />
        <div class="css-times times2" />
        <div class="css-times times3" />
      </div>
    </section>
    <section>
    ...
    <section>
      <div class="loader loader-18">
        <div class="css-star star1" />
        <div class="css-star star2" />
        <div class="css-star star3" />
        <div class="css-star star4" />
        <div class="css-star star5" />
        <div class="css-star star6" />
        <div class="css-star star7" />
        <div class="css-star star8" />
      </div>
    </section>
    <section>
    ...
    <section>
      <div class="loader loader-17">
        <div class="css-square square1" />
        <div class="css-square square2" />
        <div class="css-square square3" />
        <div class="css-square square4" />
        <div class="css-square square5" />
        <div class="css-square square6" />
        <div class="css-square square7" />
        <div class="css-square square8" />
      </div>
    </section>
    ...
    <section>
      <div class="loader loader-20">
        <div class="css-diamond" />
      </div>
    </section>
    <section>
      <div class="loader loader-13">
        <div class="css-heart heart1" />
        <div class="css-heart heart2" />
        <div class="css-heart heart3" />
        <div class="css-heart heart4" />
      </div>
    </section>
  </div>
</template>
